...
> **Application fil rouge de la formation [« Claude Code pour les Ops »](../README.md).**
> Elle est livrée **volontairement nue** : pas de `.claude/`, pas de `Dockerfile`, pas de
> manifestes Kubernetes, pas de CI. Tout cela, c'est vous qui le produisez au fil des
> [labs](../labs/) — c'est le cœur de la formation.
>
> **Travaillez sur votre propre copie**, pour garder le dépôt de formation propre :
> ```bash
